...
" The trigger used to save selected words into ${VISUAL} at visual mode
if !exists("g:UltiSnipsSaveVisualTrigger")
    let g:UltiSnipsSaveVisualTrigger = g:UltiSnipsExpandTrigger
endif
